...
En la figura~\ref{fig:git_head} se muestra el puntero HEAD apuntando a la rama master, lo que indica
...
En la figura~\ref{fig:git_head} se muestra el puntero HEAD apuntando al commit B, lo que indica que estamos
