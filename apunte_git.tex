...
\begin{itemize}[leftmargin=*]
  \item Guardar el historial completo de cambios: sabés qué cambió, cuándo y quién lo cambió.
  \item Podés volver a cualquier versión anterior si algo se rompe o si querés revisar cómo era el código antes de un cambio específico.
  \item Permite colaborar de forma ordenada, integrando aportes de varios desarrolladores sin pisar el trabajo de otros.
  \item Facilita la revisión de código, ya que podés comparar cambios y discutirlos antes de integrarlos al proyecto.
...
\begin{itemize}
  \item \textbf{Fast-forward} (avance rápido):
    ...
    En la figura \ref{fig:merge_fast_forward} se muestra un commit desde la rama devel hacia master. Antes del merge, master apunta
  ...
  \item \textbf{No-fast-forward} (sin avance rápido):
    ...
    En la figura \ref{fig:merge_no_fast_forward} se muestra un commit desde la rama devel hacia master. Antes del merge,
...
en el servidor. Es subir tu trabajo para compartirlo con otros o para tener un respaldo en la nube.

Hacer un \textbf{pull} significa traer los cambios del repositorio remoto a tu máquina local, integrándolos con tu trabajo
actual. Es descargar el trabajo de otros y mezclarlos con tu trabajo local para mantener tu copia actualizada.
...
Es basicamente la solicitud de merge de la rama donde esta tu trabajo hacia la otra rama del proyecto, pero en el repositorio remoto.
...
$ git help -a  # Lista todos los comandos disponibles
\end{verbatim}
