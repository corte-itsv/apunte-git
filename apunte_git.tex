...
Git utiliza un modelo basado en instantáneas (snapshots), donde cada confirmación (commit)
representa el estado completo del proyecto en un momento determinado.rsión.
