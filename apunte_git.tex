...
\begin{itemize}
  ...
  \item \textbf{Un mensaje} — descripción de qué cambió y por qué.
  \item \textbf{Una referencia al commit anterior} — así se forma la cadena de historia.
...
Ese hash es calculado a partir del contenido del commit, garantizando que el contenido no fue alterado,
lo que hace a los commits confiables e inmutables.

El \textbf{commit message} debe describir de forma clara qué se cambió y por qué.
...
o experimentar sin afectar la rama principal. Una vez que el trabajo en una rama está completo y probado,
se puede integrar de nuevo a main mediante un merge. Este enfoque es útil tambien a la hora de trabajar
