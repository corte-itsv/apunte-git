...
\textbf{Local} — vive en tu máquina. Ahí trabajás, hacés commits, creás ramas. Es completamente funcional sin internet.
...
Cada vez que hacés un commit, Git toma todos los cambios que preparaste (los que están en el staging area) y
      ...
      \begin{subfigure}[b]{\textwidth}
        ...
        \begin{tikzpicture}[scale=1.5, transform shape]
          ...
          \gitHEAD
            ...
            {master}          % target
        \end{tikzpicture}
        \subcaption{\ldots{} Y despues del merge Fast-forward}
      \end{subfigure}
      ...
      \begin{subfigure}[b]{\textwidth}
        ...
        \begin{tikzpicture}[scale=1.5, transform shape]
          ...
          \gitHEAD
            ...
            {master}          % target
        \end{tikzpicture}
        \subcaption{\ldots{} Y despues del merge No-Fast-forward}
      \end{subfigure}
